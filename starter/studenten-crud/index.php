...
try {
    ...
    <body class="setup-error-page">
        <main class="setup-error">
            ...
            <h1>SQLite kon niet starten</h1>
            <p><?= e($fatalError->getMessage()) ?></p>
            <p>Open <code>php.ini</code>, schakel <code>extension=pdo_sqlite</code> en <code>extension=sqlite3</code> in en herstart Apache.</p>
        </main>
    </body>
    </html>
    <?php
...
$countries = $db->query('SELECT id, naam, code FROM landen ORDER BY naam COLLATE NOCASE')->fetchAll();
$stats = $db->query(
    "SELECT
...
$sortOptions = [
    ...
    'name' => 'studenten.achternaam COLLATE NOCASE ASC, studenten.voornaam COLLATE NOCASE ASC',
    'number' => 'studenten.studentnummer COLLATE NOCASE ASC',
    'education' => 'studenten.opleiding COLLATE NOCASE ASC',
];
...
$countryQuery .= ' GROUP BY landen.id, landen.naam, landen.code, landen.regio, landen.created_at, landen.updated_at
                   ORDER BY landen.naam COLLATE NOCASE ASC';
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Voorbeeld van een studentenadministratie met PHP en SQLite.">
...
<body>
    <header class="app-header">
        ...
        <div class="environment"><span></span> SQLite lokaal</div>
    </header>
    ...
    <footer><span>Campus Admin</span><span>Gebouwd met PHP + SQLite</span></footer>
</body>
</html>
