...
const englishTranslations = {
  ...
  "Zoek een snippet": "Find a snippet",
  "Los een fout op": "Fix an error",
  "Begin met de basis.": "Start with the basics.",
  "Open extra onderdelen pas wanneer je ze nodig hebt.": "Open extra sections only when you need them.",
  "Snel naar de juiste plek": "Go straight to the right place",
  ...
  "Simpele templates voor je zichtbare pagina": "Simple templates for your visible page",
  "Navigatie, hero, footer en één kleine CSS-basis": "Navigation, hero, footer and one small CSS base",
  "Navigatie": "Navigation",
  "Hero": "Hero",
  "Footer": "Footer",
  "Basisstijl": "Base styling",
  "Kies eerst in gewone woorden wat je wilt toevoegen. Open daarna alleen dat recept. De volledige appstructuur en technische overzichten staan ingeklapt voor wanneer je verder bent.": "First choose in plain words what you want to add. Then open only that recipe. The full app structure and technical references stay collapsed until you need them.",
  "Meest gebruikt": "Most used",
  "Kies één kleine volgende stap.": "Choose one small next step.",
  "Zorg eerst dat Create, Read, Update en Delete werken. Voeg daarna één functie tegelijk toe.": "Make sure Create, Read, Update and Delete work first. Then add one feature at a time.",
  "Inloggen": "Login",
  "Zoeken": "Search",
  "Foto uploaden": "Upload photo",
  "Detailpagina": "Detail page",
  "Prullenbak": "Trash",
  "CSV export": "CSV export",
  "Complete appstructuur bekijken": "View complete app structure",
  "Appconfiguratie, bootstrap, layout, beveiliging en een route van tien stappen": "App configuration, bootstrap, layout, security and a ten-step route"
};
...
$$('[data-quick-snippet]').forEach((button) => {
  button.addEventListener("click", () => {
    const matchingPicker = snippetPickButtons.find((item) => item.dataset.snippetPick === button.dataset.quickSnippet);
    matchingPicker?.click();
    $$('[data-quick-snippet]').forEach((item) => item.classList.toggle("is-active", item === button));
  });
});
